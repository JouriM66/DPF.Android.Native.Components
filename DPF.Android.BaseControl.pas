...
const
  CTextAlign: array [TDPFTextAlignment] of TTextAlign = ( TTextAlign.Leading, TTextAlign.Leading, TTextAlign.Center, TTextAlign.Trailing, TTextAlign.Center, TTextAlign.Center, TTextAlign.Center, TTextAlign.Center, TTextAlign.Center, TTextAlign.Center, TTextAlign.Center, TTextAlign.Center, TTextAlign.Center );
...
begin
{$IFDEF ANDROID}
  LOGI( M.AsAnsi( TAndroidHelper.ApplicationTitle + LogMsg ).ToPointer );
{$ENDIF}
end;
...
begin
  ...
  if isDispatchKeyEvent then
    TAndroidHelper.Activity.dispatchKeyEvent( event );
