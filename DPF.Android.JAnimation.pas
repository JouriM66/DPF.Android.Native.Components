...
{$IFDEF ANDROID}
  ...
  private
    [weak] FDPFJAnimation: TDPFJAnimation;
  public
...
begin
  CallInUIThread(
    ...
    begin
      ...
      begin
        FJDPFAnimation.startTranslateAnimation( TAndroidHelper.Activity, //TAndroidHelper.Activity,
                                                Control.JControl, Control.ScreenScale, fromXDelta,
                                                toXDelta, fromYDelta, toYDelta, fromAlpha,
                                                toAlpha, durationMillis, FDPFOnAnimationListener );
      end
    end
     );
end;
