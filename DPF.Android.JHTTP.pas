...
{$IFDEF ANDROID}
  CallInUIThreadAndWaitFinishing(
    ...
    begin
      ...
      begin
        FJDPFHTTP.startDownload( TAndroidHelper.Activity, StringToJString( url ), StringToJString( SaveFileName ), StringToJString( UserName ), StringToJString( Password ), FDPFOnHTTPListener );
      end;
    end );
{$ENDIF}
end;
...
{$IFDEF ANDROID}
  ...
  CallInUIThreadAndWaitFinishing(
    ...
    begin
      if assigned( FJDPFHTTP ) then
      begin
        FJDPFHTTP.startUpload( TAndroidHelper.Activity, StringToJString( SaveFileName ), StringToJString( url ), mHeaders, mFields, FDPFOnHTTPListener );
      end;
    end );
{$ENDIF}
end;
