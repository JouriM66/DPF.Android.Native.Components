...
{$IFDEF ANDROID}
  CallInUIThreadAndWaitFinishing(
    ...
    begin
      FJScrollView := TJScrollView.JavaClass.init( TAndroidHelper.Activity );
      FJScrollViewContentLayout := TJLinearLayout.JavaClass.init( TAndroidHelper.Activity );
...
{$IFDEF ANDROID}
  CallInUIThreadAndWaitFinishing(
    ...
    var
      lp: JLinearLayout;
    begin
      //lp := TJLinearLayout.JavaClass.init( TAndroidHelper.Activity );
