...
{$IFDEF ANDROID}
  CallInUIThreadAndWaitFinishing(
    procedure( )
    begin
      FJSpinner := TJSpinner.JavaClass.init( TAndroidHelper.Activity );
...
begin
  CallInUIThreadAndWaitFinishing(
    ...
    begin
      ...
      FJSpinnerDataAdapter := TJArrayAdapter.JavaClass.init( TAndroidHelper.Activity, TDPFSpinnerStyleToInt[FSpinnerStyle], TJList.Wrap( ( FJSpinnerList as ILocalObject ).GetObjectID ) );
