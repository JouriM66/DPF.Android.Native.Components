...
{$IFDEF ANDROID}
  FJTabHost := TJTabHost.JavaClass.init( TAndroidHelper.Context, nil ); // nil very important for not raise exception !!!
...
begin
  try
    FLinearLayout := TJLinearLayout.JavaClass.init( TAndroidHelper.Context, nil );
    ...
    FJTabWidget := TJTabWidget.JavaClass.init( TAndroidHelper.Context, nil );
    ...
    FTabContentLayout := TJFrameLayout.JavaClass.init( TAndroidHelper.Context, nil );
    ...
    // LocalActivityManager := TJLocalActivityManager.JavaClass.init( TAndroidHelper.Activity, true );
