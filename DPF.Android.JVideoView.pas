...
{$IFDEF ANDROID}
  CallInUIThreadAndWaitFinishing(
    ...
    begin
      ...
      FJVideoView := TJDPFVideoView.JavaClass.init( TAndroidHelper.Activity );
      //FMediaController := TJMediaController.JavaClass.init( TAndroidHelper.Activity );
...
{$IFDEF ANDROID}
  CallInUIThread(
    ...
    begin
      ...
      // TAndroidHelper.Activity.getWindow.setFormat(-3);

      dm := TJDisplayMetrics.JavaClass.init;
      TAndroidHelper.Activity.getWindowManager.getDefaultDisplay.getMetrics( dm );
      h := dm.heightPixels;
      w := dm.widthPixels;
