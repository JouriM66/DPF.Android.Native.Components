...
{$IFDEF ANDROID}
  CallInUIThreadAndWaitFinishing(
    procedure( )
    begin
      FJDPFWebView := TJDPFWebView.JavaClass.init( TAndroidHelper.Activity );
      TAndroidHelper.Activity.getWindow.setFeatureInt( Window_FEATURE_PROGRESS, Window_PROGRESS_VISIBILITY_ON );
