...
{$IFNDEF HAS_J_ANIMATIONCONTROLLER}
...
{$ENDIF}
  ...
  // ----------------------------------------------------------------------------
{$IFDEF 0}
  JDPFOnAnimationListenerClass = interface( IJavaClass ) ['{72DEDAF4-DDE7-434B-B88D-86308E33DCCD}']
  end;
...
{$ELSE}
  JDPFOnAnimationListener = interface( JAnimation_AnimationListener )
  end;
  TJDPFOnAnimationListener = class( TJAnimation_AnimationListener )
  end;
{$ENDIF}
